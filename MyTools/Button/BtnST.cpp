...
/////////////////////////////////////////////////////////////////////////////
// CButtonST
#pragma warning(disable:4267) //全部关掉
// #pragma warning(once:4996) //仅显示一个

// Mask for control's type
#define BS_TYPEMASKH SS_TYPEMASK
...
void CButtonST::PreSubclassWindow() 
{
    ...
    ModifyStyle(BS_TYPEMASKH, BS_OWNERDRAW, SWP_FRAMECHANGED);
...
{
    UINT nNewType = (UINT)(wParam & BS_TYPEMASKH);
    ...
    return DefWindowProc(BM_SETSTYLE,
        (wParam & ~BS_TYPEMASKH) | BS_OWNERDRAW, lParam);
} // End of OnSetStyle
...
void CButtonST::SetDrawTransparent(bool bTransparent)
{
